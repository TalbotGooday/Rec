...
public class ChartsDataModel {
    ...
    private List<List<Entry>> dataSpectrum = new ArrayList<>();
    private List<List<Entry>> dataBand = new ArrayList<>();
    ...
    public ChartsDataModel(List<Float> wavBytes) {
        data = new ArrayList<>();
    ...
    public ChartsDataModel(WavModel wavModel) {
